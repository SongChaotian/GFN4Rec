...
class KRUserEnvironment_FiniteImmediate():
    ...
    def get_user_model(self, log_path, device, from_load = True):
        ...
        # load user model training information from log_path
    ...
    def get_reader(self, args):
        # load user model training information from log path
    ...
    def reset(self):
        ...
        # observed batchwise mean response {'{response}": [scalar]}
    ...
    def step(self, step_dict):
        ...
        with torch.no_grad():
            ...
            # all batch users stops at the same time
