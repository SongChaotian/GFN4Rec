...
class KRUserEnvironment_FiniteImmediate():
    ...
    def parse_model_args(parser):
        ...
        parser.add_argument('--item_correlation', type=float, default=0, help='物品相关性惩罚系数')
        parser.add_argument('--new_reader_class', type=str, default='', help='离线训练时使用的数据读取器')
        parser.add_argument('--env_val_holdout', type=int, default=0, help='验证集保留数量')
        parser.add_argument('--env_test_holdout', type=int, default=0, help='测试集保留数量')
        return parser
